...
(function (root, factory) {
    ...
    var leftArrow = '<svg width="44" height="60">' +
            '<polyline points="30 10 10 30 30 50" stroke="rgba(255, 0, 0, 0.5)" stroke-width="4"' +
              'stroke-linecap="butt" fill="none" stroke-linejoin="round"/>' +
            '</svg>',
        rightArrow = '<svg width="44" height="60">' +
            '<polyline points="14 10 34 30 14 50" stroke="rgba(255, 0, 0, 0.5)" stroke-width="4"' +
              'stroke-linecap="butt" fill="none" stroke-linejoin="round"/>' +
            '</svg>',
    ...
    var options = {},
        defaults = {
            ...
            afterHide: null,
            onChange: null,
            overlayBackgroundColor: 'rgba(229, 163, 255, 0.8)',
            closeX: closeX,
            leftArrow: leftArrow,
